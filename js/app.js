...
function afficherIngredients() {
  ...
  const ingredientsIgnores = new Set(["sel", "poivre", "poivre noir", " beurre non salé", "huile de canola", "eau", " poivre noir moulu", "eau froide", "poivre noir frais moulu", "beurre", "huile", "huile d'olive", "eau", "sucre"]);
recettes.forEach(r => {
  const mots = new Set();
